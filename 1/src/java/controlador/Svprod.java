 ...
 * @author cruzr
 */
@WebServlet(name = "Svprod", urlPatterns = {"/Svprod"})
public class Svprod extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String nombre=request.getParameter("nombrep").toUpperCase();        
        ...
        arrayyp.arrayproducto.add(objetoproducto);
            ...
            out.println("</head>");
            out.println("<body>"+ "<h1>");
            out.println("Del producto "+nombre+" de precio "+precio+ " hay "+existencia+" en existencia"
